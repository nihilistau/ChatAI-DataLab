...
| `recipe` | Workshop recipes (notebooks), widgets | Data scientists |
| `metrics` | `workshop/scripts`, telemetry helpers | Data scientists |
...
- `relay/backend/app/api/routes.py` → `# @tag:backend,api,ops`
- `relay/frontend/src/components/TailLogCell.tsx` → `/* @tag:ui,tail-log */`
