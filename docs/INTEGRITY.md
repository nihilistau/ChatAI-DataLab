...
3. **Verify file(s)**: `python scripts/project_integrity.py verify relay/backend/app/models.py`
...
5. **Repair**: `python scripts/project_integrity.py repair relay/backend/app/models.py --checkpoint latest`
...
```jsonc
{
   "path": "relay/backend/app/models.py",
  "hash": "sha256:...",
  "size": 5123,
...
| Directory drift | `python scripts/project_integrity.py repair relay/backend --checkpoint 0005` |
