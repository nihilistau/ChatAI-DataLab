...
function App() {
    const [themeKey, setThemeKey] = useState(() => {
        ...
        const stored = window.localStorage.getItem("chatai.theme");
    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            window.localStorage.setItem("chatai.theme", themeKey);
        }
    }, [themeKey]);
