"""Workshop helpers for working with Elements graphs inside notebooks."""
# @tag: workshop,scripts,elements
    ...
    "qa_loop": {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "type": "notebook",
                "label": "Notebook",
                "props": {"notebook": "control_center_relay.ipynb"},
            },
        ],
        "edges": [
            {
...
def _handle_notebook(_: dict[str, Any], props: dict[str, Any], inputs: dict[str, Any]) -> dict[str, Any]:
    notebook = props.get("notebook", "control_center_relay.ipynb")
