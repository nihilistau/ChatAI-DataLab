...
# @tag: workshop,scripts,analytics
...
import pandas as pd
from workshop.lab_paths import data_path
...
def load_interactions(
    ...
    *,
    ...
    uses :func:`data_store_context` so Workshop/DataLab assets honor whichever
    provider the Relay backend is currently using (SQLite, Cosmos, JSON).
    """
