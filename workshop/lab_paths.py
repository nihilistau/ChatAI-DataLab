"""Workshop-native path helpers shared across notebooks and automation relays."""
# @tag: workshop,paths
...
def get_lab_root() -> Path:
	...
	# Module lives under <repo>/workshop, so ascend one level by default.
