"""Structured diagnostics helpers shared by notebooks, scripts, and Workshop hooks."""
# @tag: workshop,diagnostics
...
DEFAULT_SNAPSHOT_PATH = lab_path("workshop", "notebooks", "_papermill", "control_center_snapshot.json")
DEFAULT_METADATA_PATH = lab_path("workshop", "notebooks", "_papermill", "run_metadata.json")
