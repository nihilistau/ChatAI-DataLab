...
"""FastAPI entry point for the Playground backend."""
# @tag:backend,api
...
from app.api.playgrounds import router as playgrounds_router
...
app = FastAPI(title="Playground FastAPI", version="0.1.0", lifespan=lifespan)
