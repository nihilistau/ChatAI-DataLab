...
interface ManifestLayoutPreviewProps {
  manifest: RelayManifestRecord;
}

const getWidgetLabel = (widget: RelayWidget, index: number): string => {
...
const getWidgetHint = (widget: RelayWidget): string => {
...
const renderWidget = (widget: RelayWidget, index: number) => {
...
const renderSection = (section: RelayLayoutSection, index: number) => {
...
const renderAction = (action: RelayAction) => {
  return (
    ...
    <div className="manifest-preview">
      <div className="manifest-meta-grid">
        <article className="manifest-meta-card">
          ...
          <h3>
            {manifest.tenant}/{manifest.relay}
          </h3>
          <small>
