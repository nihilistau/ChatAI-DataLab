...
// --- Relay manifest contracts ---------------------------------------

export type RelayActionMethod = "GET" | "POST" | "PUT" | "PATCH" | "DELETE" | string;

export interface RelayAction {
  id?: string;
  title?: string;
  route: string;
  method?: RelayActionMethod;
  description?: string;
}
...
export interface RelayLayoutSection {
  id?: string;
  title?: string;
  description?: string;
  accent?: string;
...
export interface RelayManifestRecord {
  id: string;
  tenant: string;
  relay: string;
  revision: number;
