...
# --- Release log entries ----------------------------------------------------
class ReleaseTimelineEntry(APIModel):
    name: str
    status: str
...
class ReleaseLogEntryRead(APIModel):
    id: str
    timestamp: datetime
    kind: str
    ...
    goal_milestone: str | None = None
    change_master_id: str | None = None
    notes: str | None = None
    ...
    timeline: list[ReleaseTimelineEntry] = Field(default_factory=list)
...
# --- Relay manifest schemas ------------------------------------------
class RelayManifestBase(APIModel):
...
class RelayManifestCreate(RelayManifestBase):
...
class RelayManifestRead(RelayManifestBase):
    id: str
    tenant: str
    relay: str
    revision: int
